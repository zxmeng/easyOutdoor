...
<div class="masonry">				
   ...
   <div class="item">
   		...
   		<div class="item-picture">
   			<img class="item-picture" src="<?php echo BASE_URL; ?><?php echo $event['profilePhoto']; ?>">
   		</div>
   		...
   		<div align="right">
   			<div class="button" type="button" onclick="loadEvent( <?php echo $event['ID'].', '.$event['ownerID']; ?> )">
   				More Infomation
   			</div>
   		</div>		   		
   </div>
