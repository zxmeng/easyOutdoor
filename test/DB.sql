...
CREATE TABLE Message(
	...
	uid INT NOT NULL REFERENCES User(uid),
	rid INT NOT NULL REFERENCES Chatroom(rid),
...
CREATE TABLE Comment(
	...
	content VARCHAR(200) NOT NULL,
	suid INT NOT NULL REFERENCES User(uid),
	ruid INT REFERENCES User(uid),
	eid INT NOT NULL REFERENCES Event(eid),
	time DATETIME NOT NULL
);

CREATE TABLE Friend(
	uidA INT NOT NULL REFERENCES User(uid),
	uidB INT NOT NULL REFERENCES User(uid)
);
